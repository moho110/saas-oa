...
--
BEGIN;
INSERT INTO `xinhu_book` (`id`, `title`, `typeid`, `num`, `author`, `chuban`, `cbdt`, `price`, `weizhi`, `shuliang`, `adddt`, `optdt`, `optname`, `optid`, `content`, `isbn`, `jieshu`, `comid`) VALUES
(1, 'C语言程序设计', 232, 'TS-001', '巨同升', '中国日报', '2012-10-01', '20.00', '忘了', 1, '2016-10-28 23:18:36', '2016-10-28 23:21:53', '管理员', 1, '本书在内容编排上，采用“应用驱动知识”的方式，即根据每一章应用目标的需求，合理地安排每一个知识主题的引入点，从而将C语言中枯燥难懂的语法知识分解到全书各章并融入到丰富的实例中。本书在编程方法的讲解上，采用“逐步构造法”，即通过问题分析、算法设计、程序原型等环节一步一步地构造出完整的程序，从而加深读者对编程方法的理解和掌握。', NULL, 0, 0),
(2, 'PHP从入门到精通', 232, 'TS-002', '潘凯华', '化学工业出版社', '2008-10-01', '68.00', '忘了', 1, '2016-10-28 23:25:22', '2016-10-28 23:27:07', '管理员', 1, NULL, '9787302179597', 0, 0),
(3, '1', 1, '1', '1', '1', '2022-04-08', '1.00', '1', 1, '2022-04-08 00:00:00', '2022-04-08 00:00:00', '1', 1, '10074', '1', 1, 1);
COMMIT;
...
INSERT INTO `gen_table` VALUES (4, 'xinhu_book', '图书表', NULL, NULL, 'XinhuBook', 'crud', 'com.vrmlstudio.crm', 'book', 'book', '图书表', 'vrmlstudio', '0', '/', '{\"parentMenuId\":\"2008\"}', 'admin', '2022-01-18 18:10:56', '', '2022-01-19 10:54:01', NULL);
COMMIT;
