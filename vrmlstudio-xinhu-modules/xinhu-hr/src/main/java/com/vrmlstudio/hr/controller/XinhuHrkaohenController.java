 ...
 */
@RestController
@RequestMapping("/xinhu-hr/hrkaohen")
public class XinhuHrkaohenController extends BaseController
{
     ...
     * 查询考核项目人员列表
     */
    @PreAuthorize("@ss.hasPermi('xinhu-hr:hrkaohen:list')")
    @GetMapping("/list")
     ...
     * 导出考核项目人员列表
     */
    @PreAuthorize("@ss.hasPermi('xinhu-hr:hrkaohen:export')")
     ...
     * 获取考核项目人员详细信息
     */
    @PreAuthorize("@ss.hasPermi('xinhu-hr:hrkaohen:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增考核项目人员
     */
    @PreAuthorize("@ss.hasPermi('xinhu-hr:hrkaohen:add')")
     ...
     * 修改考核项目人员
     */
    @PreAuthorize("@ss.hasPermi('xinhu-hr:hrkaohen:edit')")
     ...
     * 删除考核项目人员
     */
    @PreAuthorize("@ss.hasPermi('xinhu-hr:hrkaohen:remove')")
